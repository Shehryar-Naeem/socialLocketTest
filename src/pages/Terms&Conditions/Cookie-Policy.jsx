...
const CookiePolicy = () => {
    return (
      <div>
        ...
        <div className="box-shadow mb-3 py-4">
          <div className="privacy-tabs">
            <ul>
              <li><Link to={"/terms-conditions"} >Terms & Conditions</Link></li>
              <li><Link to={"/privacy-Notice"}>Privacy Notice</Link></li>
              <li><Link to={"/cookie-Policy"} className="active">Cookie Policy</Link></li>
              <li><Link to={"/acceptable-Policy"}>Acceptable Use Policy</Link></li>
            </ul>            
          </div>
        </div>
